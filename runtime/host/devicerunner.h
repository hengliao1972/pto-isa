...
public:
     ...
     * @param numCores       Number of cube (AIC) blocks to launch (e.g., 24 on A3).
     *                      NOTE: the runtime also launches vector (AIV) subblocks; total handshake workers are derived
     *                      from this count.
     ...
     *
     * Example:
     *   runner.Init(0, 24, "./aicpu/lib.so", "./aicore/kernel.o");
