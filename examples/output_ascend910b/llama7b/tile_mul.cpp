...
/**
 * InCore Function: tile_mul
 * Single-core tile computation function.
 * Called by PTO Runtime as a scheduled task.
 * NOT a kernel entry - use tile_mul_kernel_wrapper() to launch as kernel.
 */
class tile_mulInCore {
public:
    // Single-core constructor - no block coordination
    __aicore__ inline tile_mulInCore() {}
 ...
 */
__aicore__ inline void tile_mul(
 ...
 */
extern "C" __global__ __aicore__ void tile_mul_kernel(GM_ADDR input, GM_ADDR output) {
    tile_mulInCore op;
