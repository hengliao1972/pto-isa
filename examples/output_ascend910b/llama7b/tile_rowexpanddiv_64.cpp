...
// ======================================================================
// TILE BUFFER ANALYSIS: tile_rowexpanddiv_64
// ======================================================================
//
// SUMMARY:
...
/**
 * InCore Function: tile_rowexpanddiv_64
 * Single-core tile computation function.
 * Called by PTO Runtime as a scheduled task.
 * NOT a kernel entry - use tile_rowexpanddiv_64_kernel_wrapper() to launch as kernel.
 */
class tile_rowexpanddiv_64InCore {
public:
    // Single-core constructor - no block coordination
    __aicore__ inline tile_rowexpanddiv_64InCore() {}
...
private:
    ...
    __aicore__ inline void Compute() {
        ...
        BroadcastDiv(result, x, row_vals, 64, 8);  // row-wise broadcast divide
        // TSTORE: Operation
 ...
 */
__aicore__ inline void tile_rowexpanddiv_64(
 ...
 */
extern "C" __global__ __aicore__ void tile_rowexpanddiv_64_kernel(GM_ADDR input, GM_ADDR output) {
    tile_rowexpanddiv_64InCore op;
