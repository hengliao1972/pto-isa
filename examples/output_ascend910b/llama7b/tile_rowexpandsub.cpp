...
/**
 * InCore Function: tile_rowexpandsub
 * Single-core tile computation function.
 * Called by PTO Runtime as a scheduled task.
 * NOT a kernel entry - use tile_rowexpandsub_kernel_wrapper() to launch as kernel.
 */
class tile_rowexpandsubInCore {
public:
    // Single-core constructor - no block coordination
    __aicore__ inline tile_rowexpandsubInCore() {}
 ...
 */
__aicore__ inline void tile_rowexpandsub(
 ...
 */
extern "C" __global__ __aicore__ void tile_rowexpandsub_kernel(GM_ADDR input, GM_ADDR output) {
    tile_rowexpandsubInCore op;
