...
// ======================================================================
// TILE BUFFER ANALYSIS: tile_matmul
// ======================================================================
//
// SUMMARY:
...
/**
 * InCore Function: tile_matmul
 * Single-core tile computation function.
 * Called by PTO Runtime as a scheduled task.
 * NOT a kernel entry - use tile_matmul_kernel_wrapper() to launch as kernel.
 */
class tile_matmulInCore {
public:
    // Single-core constructor - no block coordination
    __aicore__ inline tile_matmulInCore() {}
 ...
 */
__aicore__ inline void tile_matmul(
 ...
 */
extern "C" __global__ __aicore__ void tile_matmul_kernel(GM_ADDR input, GM_ADDR output) {
    tile_matmulInCore op;
