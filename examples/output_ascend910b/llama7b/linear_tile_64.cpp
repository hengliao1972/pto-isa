...
/**
 * InCore Function: linear_tile_64
 * Single-core tile computation function.
 * Called by PTO Runtime as a scheduled task.
 * NOT a kernel entry - use linear_tile_64_kernel_wrapper() to launch as kernel.
 */
class linear_tile_64InCore {
public:
    // Single-core constructor - no block coordination
    __aicore__ inline linear_tile_64InCore() {}
 ...
 */
__aicore__ inline void linear_tile_64(
 ...
 */
extern "C" __global__ __aicore__ void linear_tile_64_kernel(GM_ADDR input, GM_ADDR output) {
    linear_tile_64InCore op;
