...
/**
 * InCore Function: tile_rsqrt
 * Single-core tile computation function.
 * Called by PTO Runtime as a scheduled task.
 * NOT a kernel entry - use tile_rsqrt_kernel_wrapper() to launch as kernel.
 */
class tile_rsqrtInCore {
public:
    // Single-core constructor - no block coordination
    __aicore__ inline tile_rsqrtInCore() {}
 ...
 */
__aicore__ inline void tile_rsqrt(
