 ...
 * NOT a kernel entry - use tile_add_kernel_wrapper() to launch as kernel.
 */
class tile_addInCore {
public:
    // Single-core constructor - no block coordination
    __aicore__ inline tile_addInCore() {}
 ...
 */
__aicore__ inline void tile_add(
 ...
 */
extern "C" __global__ __aicore__ void tile_add_kernel(GM_ADDR input, GM_ADDR output) {
    tile_addInCore op;
