 ...
 * NOT a kernel entry - use tile_exp_64_kernel_wrapper() to launch as kernel.
 */
class tile_exp_64InCore {
public:
    // Single-core constructor - no block coordination
    __aicore__ inline tile_exp_64InCore() {}
 ...
 */
__aicore__ inline void tile_exp_64(
 ...
 */
extern "C" __global__ __aicore__ void tile_exp_64_kernel(GM_ADDR input, GM_ADDR output) {
    tile_exp_64InCore op;
