...
/**
 * InCore Function: rope_tile
 * Single-core tile computation function.
 * Called by PTO Runtime as a scheduled task.
 * NOT a kernel entry - use rope_tile_kernel_wrapper() to launch as kernel.
 */
class rope_tileInCore {
public:
    // Single-core constructor - no block coordination
    __aicore__ inline rope_tileInCore() {}
 ...
 */
__aicore__ inline void rope_tile(
