 ...
 * NOT a kernel entry - use flash_attn_normalize_kernel_wrapper() to launch as kernel.
 */
class flash_attn_normalizeInCore {
public:
    // Single-core constructor - no block coordination
    __aicore__ inline flash_attn_normalizeInCore() {}
 ...
 */
__aicore__ inline void flash_attn_normalize(
