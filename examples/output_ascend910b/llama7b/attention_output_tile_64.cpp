 ...
 * NOT a kernel entry - use attention_output_tile_64_kernel_wrapper() to launch as kernel.
 */
class attention_output_tile_64InCore {
public:
    // Single-core constructor - no block coordination
    __aicore__ inline attention_output_tile_64InCore() {}
 ...
 */
__aicore__ inline void attention_output_tile_64(
    ...
    int32_t tile_rows, int32_t tile_cols)
{
    ...
    attention_output_tile_64InCore op;
