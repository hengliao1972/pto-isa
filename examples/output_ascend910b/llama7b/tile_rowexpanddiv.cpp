...
/**
 * InCore Function: tile_rowexpanddiv
 * Single-core tile computation function.
 * Called by PTO Runtime as a scheduled task.
 * NOT a kernel entry - use tile_rowexpanddiv_kernel_wrapper() to launch as kernel.
 */
class tile_rowexpanddivInCore {
public:
    // Single-core constructor - no block coordination
    __aicore__ inline tile_rowexpanddivInCore() {}
 ...
 */
__aicore__ inline void tile_rowexpanddiv(
 ...
 */
extern "C" __global__ __aicore__ void tile_rowexpanddiv_kernel(GM_ADDR input, GM_ADDR output) {
    tile_rowexpanddivInCore op;
