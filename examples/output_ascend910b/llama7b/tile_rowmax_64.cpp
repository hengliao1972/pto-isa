...
/**
 * InCore Function: tile_rowmax_64
 * Single-core tile computation function.
 * Called by PTO Runtime as a scheduled task.
 * NOT a kernel entry - use tile_rowmax_64_kernel_wrapper() to launch as kernel.
 */
class tile_rowmax_64InCore {
public:
    // Single-core constructor - no block coordination
    __aicore__ inline tile_rowmax_64InCore() {}
 ...
 */
__aicore__ inline void tile_rowmax_64(
 ...
 */
extern "C" __global__ __aicore__ void tile_rowmax_64_kernel(GM_ADDR input, GM_ADDR output) {
    tile_rowmax_64InCore op;
