 ...
 * NOT a kernel entry - use tile_rowsum_kernel_wrapper() to launch as kernel.
 */
class tile_rowsumInCore {
public:
    // Single-core constructor - no block coordination
    __aicore__ inline tile_rowsumInCore() {}
 ...
 */
__aicore__ inline void tile_rowsum(
