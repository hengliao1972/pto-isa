...
/**
 * InCore Function: tile_rowexpandsub_64
 * Single-core tile computation function.
 * Called by PTO Runtime as a scheduled task.
 * NOT a kernel entry - use tile_rowexpandsub_64_kernel_wrapper() to launch as kernel.
 */
class tile_rowexpandsub_64InCore {
public:
    // Single-core constructor - no block coordination
    __aicore__ inline tile_rowexpandsub_64InCore() {}
...
private:
    ...
    __aicore__ inline void Compute() {
        ...
        // FUSED (2 ops): TROWEXPANDSUB; TSTORE
        BroadcastSub(result, x, row_vals, 64, 8);  // row-wise broadcast subtract
        // TSTORE: Operation
 ...
 */
__aicore__ inline void tile_rowexpandsub_64(
 ...
 */
extern "C" __global__ __aicore__ void tile_rowexpandsub_64_kernel(GM_ADDR input, GM_ADDR output) {
    tile_rowexpandsub_64InCore op;
