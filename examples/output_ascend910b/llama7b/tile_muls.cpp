 ...
 * NOT a kernel entry - use tile_muls_kernel_wrapper() to launch as kernel.
 */
class tile_mulsInCore {
public:
    // Single-core constructor - no block coordination
    __aicore__ inline tile_mulsInCore() {}
 ...
 */
__aicore__ inline void tile_muls(
 ...
 */
extern "C" __global__ __aicore__ void tile_muls_kernel(GM_ADDR input, GM_ADDR output) {
    tile_mulsInCore op;
