...
- Linux aarch64: `bin/linux-aarch64/ptoas.tar.gz` is included in this repo (auto-extracted on first use).
...
This repo focuses on the Ascend runtime workflow (AICPU orchestration + AICore execution).
